...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.member_since'
        db.add_column(u'main_profile', 'member_since',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Link.created'
        db.add_column(u'main_link', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Link.updated'
        db.add_column(u'main_link', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.member_since'
        db.delete_column(u'main_profile', 'member_since')

        # Deleting field 'Link.created'
        db.delete_column(u'main_link', 'created')

        # Deleting field 'Link.updated'
        db.delete_column(u'main_link', 'updated')
    ...
    models = {
        ...
        u'main.link': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'links'", 'to': u"orm['auth.User']"})
        },
        u'main.profile': {
            ...
            'member_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
